...
if(rb1.isSelected()){    
JOptionPane.showMessageDialog(this,"You are male by gender.");    
}    
if(rb2.isSelected()){    
JOptionPane.showMessageDialog(this,"You are female by gender.");    
}    
if(rb3.isSelected()){    
    JOptionPane.showMessageDialog(this,"You are neutral by gender.");    
    }    
}    
